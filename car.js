    ...
    .then((hasil) => {
        ...
        for (let i = 0; i < hasil.length; i++) {
            ...
            car.innerHTML = `<div class="col mb-3"> 
                            <div class="card"> 
                            <img src="${hasil[i].image}" class="card-img-top" style="width: 350px; height:350px">
...
const filterCar = (char, data, input3) => {   

    let NewFilter = Allcar.filter(car => car.manufacture.toLowerCase().includes(char))
    ...
    card.innerHTML = ''
        ...
        NewFilter.forEach((element, id) => {
            ...
            car1.innerHTML = `<div class="col mb-3"> 
                            <div class="card"> 
                            <img src="${element.image}" class="card-img-top" style="width: 350px; height:350px">
